...
**MinaChat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Pham Vuong Trieu**

Time spent: **30** hours

URL: **https://minachat.herokuapp.com/**
